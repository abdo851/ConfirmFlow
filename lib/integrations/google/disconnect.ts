...
export async function disconnectGoogleConnection(ownerId: string): Promise<void> {
  ...
  await db.from("google_connections").delete().eq("store_connection_id", storeConnection.id);
