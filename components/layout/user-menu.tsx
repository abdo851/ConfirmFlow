  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        className={
          variant === "card"
            ? `flex w-full items-center gap-3 rounded-xl px-2 py-2 text-start hover:bg-surface-muted ${collapsed ? "justify-center" : ""}`
            : "inline-flex size-11 shrink-0 items-center justify-center rounded-full bg-primary text-sm font-semibold text-primary-foreground"
        }
        aria-haspopup="menu"
        aria-expanded={open}
      ...
      {open ? (
        <div
          ...
          className={`menu-pop absolute z-50 w-64 rounded-xl border border-line bg-surface p-2 shadow-large ${
